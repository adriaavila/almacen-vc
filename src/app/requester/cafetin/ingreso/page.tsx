            ...
            <div className="mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">
                        Registrar Ingresos a Cafetín
                    </h1>
                    <p className="text-sm text-gray-500 mt-1">
                        Agrega compras o ajustes directos al inventario del Cafetín
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white p-5 rounded-lg border border-gray-200 shadow-sm">
                        <h2 className="font-semibold text-gray-900 mb-4 border-b pb-2">Configuración</h2>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="0"
                                        className="block w-full h-12 text-xl text-center border border-gray-300 rounded-md bg-white placeholder-gray-400 focus:outline-none focus:ring-2 font-semibold focus:ring-emerald-500 focus:border-emerald-500"
                                    />
                                    {selectedProduct && (
                ...
                <div className="lg:col-span-2 flex flex-col h-full space-y-4">
                    ...
                    <Button
                        ...
                        className="w-full h-14 text-lg shadow-md bg-emerald-600 hover:bg-emerald-700 focus:ring-emerald-500"
                    >
