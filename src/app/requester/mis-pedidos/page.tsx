...
export default function MyOrdersPage() {
  ...
  const ordersLasCasas = useQuery(api.orders.getByArea, { area: 'Las casas' });
  ...
  const isLoading = ordersCocina === undefined || ordersCafetin === undefined || ordersLimpieza === undefined || ordersLasCasas === undefined;
