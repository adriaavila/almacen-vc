  ...
  return (
    <PageContainer>
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <Link href="/admin/movements/new-bulk?type=ingreso">
          <Button variant="primary" className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            </svg>
            Registrar Ingreso <span className="hidden sm:inline">(Múltiple / Sin pedido)</span>
          </Button>
        </Link>
        <Link href="/admin/movements/new-bulk?type=entrega">
          <Button variant="primary" className="flex items-center gap-2 bg-red-600 hover:bg-red-700">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4" />
            </svg>
            Registrar Entrega <span className="hidden sm:inline">(Múltiple / Sin solicitud)</span>
          </Button>
        </Link>
      </div>
